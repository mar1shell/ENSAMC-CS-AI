...
int prod_shift_iter(int n, int m) {
    /**
     ...
     * It dosen't handle negative inputs.
     *
     * Return:
...
int prod_shift_rec(int n, int m) {
    /**
    ...
    return (n % 2 == 0) ? prod_shift_rec(n / 2, m * 2) : m + prod_shift_rec(n / 2, m * 2);
}
...
int main() {
    ...
    printf("Product of 6 and 7: %d\n", prod_shift_iter(6, 7));    // 42
    printf("Product of -6 and 7: %d\n", prod_shift_iter(-6, 7));  // -42
    printf("Product of 6 and -7: %d\n", prod_shift_iter(6, -7));  // -42
    printf("Product of -6 and -7: %d\n", prod_shift_iter(-6, -7)); // 42
    printf("Product of 0 and 5: %d\n", prod_shift_iter(0, 5));    // 0
    
    // Recursive approach
    
    printf("Product of 6 and 7: %d\n", prod_shift_rec(6, 7));    // 42
    printf("Product of 10 and 5: %d\n", prod_shift_rec(10, 5));  // 50
    printf("Product of 7 and 13: %d\n", prod_shift_rec(7, 13));  // 91
    printf("Product of 0 and 5: %d\n", prod_shift_rec(0, 5));    // 0
    return 0;
}